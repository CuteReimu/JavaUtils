...
class SnakePoint {
    ...
    public boolean equals(Object anObject) {
        if (!(anObject instanceof SnakePoint))
            return false;
        return x == ((SnakePoint) anObject).x && y == ((SnakePoint) anObject).y;
    }
...
public class Snake extends JFrame {
    private static final int initLen = 5;
    ...
    private void move() {
        ...
        SnakePoint nextPoint = switch (direction) {
            case 1 -> new SnakePoint(firstPoint.x, firstPoint.y - 1);
            case 2 -> new SnakePoint(firstPoint.x, firstPoint.y + 1);
            case 3 -> new SnakePoint(firstPoint.x - 1, firstPoint.y);
            case 4 -> new SnakePoint(firstPoint.x + 1, firstPoint.y);
            default -> throw new RuntimeException(String.valueOf(direction));
        };
    ...
    private void display() {
        ...
        for (SnakePoint point : snakePoint)
            button[point.hashCode()].setBackground(Color.BLACK);
